...
# <click on play, this create the absolute path top the parent dir
# Don't forget to prepend your path with CURR_DIR if needed
CURR_DIR = os.path.dirname(__file__)
print(CURR_DIR + "/static/cred.json")
