...
class Snake:
    ...
    ********************************************************************************************************************
    ...
    def __init__(self, color) -> None:
        ...
        while head.x < NB_INITIAL_SNAKE_SEGMENTS*BLOCK_SIZE:
        ...
        # ]
        self.body = [Point(WIDTH, HEIGHT, head.x-i*BLOCK_SIZE, head.y) for i in range(NB_INITIAL_SNAKE_SEGMENTS)]
    ...
    def change_direction(self, direction: str) -> None:
        ...
        if direction in valid_directions[self._current_direction]:
            self._current_direction = direction
...
# Helpers functions
def press_space_to_start(font, text):
  start_text = font.render(text, True, WHITE, BLACK)
...
def snake_game():
  ...
  running = press_space_to_start(font, "Press SPACE to start the game") # -> blocking function
  ...
  #Clear canvas
  press_space_to_start(font, "Game Over !")
